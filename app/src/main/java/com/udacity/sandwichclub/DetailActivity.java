...
public class DetailActivity extends AppCompatActivity {
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        String placeOfOriginString = sandwich.getPlaceOfOrigin();
            ...
            else placeOfOrigin.setText(R.string.no_information);
        ...
        if (!sandwich.getAlsoKnownAs().isEmpty()) {
            alsoKnownAs.setText(sandwich.getAlsoKnownAs().toString().replaceAll("\\[|\\]", ""));
        }
        else alsoKnownAs.setText(R.string.no_information);
